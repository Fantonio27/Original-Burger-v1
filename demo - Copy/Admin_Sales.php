...
<head>
    ...
    <title>Sales  | Orginal Burger</title>
...
<nav class="sidebar close">
    ...
    <div class="input-group mb-3" >
            ...
            <input type="text" name="search" class="form-control" placeholder="Search from order number">
        ...
        <div class="card" >
            ...
            <?php
                ...
                if(isset($_GET['search'])){
                    $status = 'Approved';
                    $search = $_GET['search'];
                    $query = "SELECT * FROM orders WHERE STATUS = '$status' && ORDER_NO LIKE '%$search%'";
                } else {
            ...
            ?>
                ...
                <div class="col-12" style="background-color: #212529">
                    <p style = "color: rgb(219, 219, 219); font-size: 25px; margin: 8px;">Total Sales:
